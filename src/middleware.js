...
//   // IMPORTANT: Allow access to public routes without token
//   if (isPublicRoute) {
//     console.log(`[Middleware] Public route ${path}, allowing access`);
//     return NextResponse.next();
//   }
...
//         `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.${token}.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30`
//       );
...
//   // 1. If user has NO token and tries to access protected routes, redirect to signup
//   if (!token && !isPublicRoute) {
//     console.log("[Middleware] No token, redirecting from", path, "to /signup");
//     return NextResponse.redirect(new URL("/signup", request.url));
//   }

//   // 2. If user HAS token and tries to access root path, redirect based on role
//   if (token && path === "/") {
//     console.log(
//       `[Middleware] Has token, redirecting from / to appropriate superadmin`
//     );
...
//   // 3. If user has token and tries to access signup, redirect to superadmin
//   if (token && isPublicRoute) {
//     console.log(
//       `[Middleware] Has token, redirecting from ${path} to superadmin`
//     );
