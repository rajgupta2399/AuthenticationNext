...
const programsData = {
  "2024-25": [
    ...
    {
      name: " Global Health Innovation Grants",
...
const Page = () => {
  ...
  const getProgramLinks = (programId, program) => {
    ...
    links.push(
      <Link
        key="beneficiaries"
        href={`/donor-alumni/initiated-projects/view-beneficiaries-details/${programId}`}
    ...
    switch (programId) {
      ...
      case "program-c":
        ...
        links.push(
          <Link
            key="report"
            href={`/donor-alumni/initiated-projects/view-report/${programId}`}
            className="inline-flex items-center justify-center px-3 py-2 bg-white border border-brand-500 text-brand-600 rounded-lg hover:bg-brand-50 font-medium text-sm transition-colors shadow-sm"
          >
            View Report
          </Link>,
          <Link
            key="frl"
            href={`/donor-alumni/initiated-projects/view-frl/${programId}`}
            className="inline-flex items-center justify-center px-3 py-2 bg-white border border-brand-500 text-brand-600 rounded-lg hover:bg-brand-50 font-medium text-sm transition-colors shadow-sm"
          >
            View FRL
          </Link>,
      ...
      case "program-d":
        ...
        links.push(
          ...
          <Link
            key="uc"
            href={`/donor-alumni/initiated-projects/view-uc/${programId}`}
            className="inline-flex items-center justify-center px-3 py-2 bg-white border border-brand-500 text-brand-600 rounded-lg hover:bg-brand-50 font-medium text-sm transition-colors shadow-sm"
          >
            View UC
          </Link>,
    ...
    switch (programId) {
      ...
      case "program-c":
        links.push(
          <Link
            key="report"
            href={`/donor-alumni/initiated-programs/view-report/${programId}`}
          >
            <Button className="w-full justify-center">View Report</Button>
          </Link>,
          <Link
            key="frl"
            href={`/donor-alumni/initiated-programs/view-frl/${programId}`}
          >
      ...
      case "program-d":
        links.push(
          ...
          <Link
            key="uc"
            href={`/donor-alumni/initiated-programs/view-uc/${programId}`}
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
              {selectedProgram == "program-a" ? (
                <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                  HCL Foundation Project Feedback
                </h3>
              ) : (
                <h3 className="text-xl font-semibold text-gray-800 dark:text-white">
                  {selectedProgram.name} Project Feedback
                </h3>
              )}
            ...
            <form onSubmit={handleFeedbackSubmit} className="p-6">
              ...
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  HCL Foundation Project Your Feedback
                </label>
                <TextArea
