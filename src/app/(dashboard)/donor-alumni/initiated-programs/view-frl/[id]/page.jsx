  ...
  return (
    <div className="w-full h-full">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        >
          <span className="sm:inline hidden">← Back to Initiated Programs</span>
            ...
            <Table>
              <TableHeader className="border-b border-gray-100 dark:border-white/[0.05] bg-gray-50 dark:bg-gray-800/50">
                <TableRow>
                  <TableCell
                    isHeader
                    className="px-3 py-3 font-semibold text-gray-700 dark:text-gray-300 text-center text-sm whitespace-nowrap sm:hidden block"
                  >
                    FRL
                  </TableCell>
                  <TableCell
                ...
                {reports.map((report) => (
                  ...
                  >
                    <TableCell className="px-3 py-3 text-start text-theme-sm sm:hidden block">
                      <Button onClick={() => openPdfViewer(report.frl)}>
                        View FRL
                      </Button>
                    </TableCell>
