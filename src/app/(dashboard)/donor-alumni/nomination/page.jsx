...
const Page = () => {
  ...
  const nominationButtons = [
    {
      name: "YAA",
      path: "/donor-alumni/nomination/yaa-nomination",
      description: "Young Alumni Award Nomination",
    },
    {
      name: "DSA",
      path: "/donor-alumni/nomination/dsa-nomination",
      description: "Distinguished Service Award Nomination",
    },
    {
      name: "SKDA",
      path: "/donor-alumni/nomination/skda-nomination",
      description: "Sri Krishna Dev Award Nomination",
    },
    {
      name: "DAA",
      path: "/donor-alumni/nomination/daa-nomination",
          ...
          {nominationButtons.map((button, index) => (
            ...
            >
              ...
              <Button
                onClick={() =>
                  handleRedirect(
                    "/donor-alumni/nomination/final-submit-nomination"
                  )
                }
