...
const nomineeSchema = yup.object().shape({
  nomineeSolution: yup.string().required("Solution is required"),
  rollNumber: yup.string().optional(),
  ...
  <div className="p-8 text-center">
    <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-lg">
      ...
      <h3 className="text-2xl font-bold text-gray-800 dark:text-white/90 mb-2">
        SKDA Nomination Submitted Successfully!
      </h3>
      <p className="text-gray-600 dark:text-gray-400">
        Thank you for submitting your SKDA nomination. We'll review your
...
const SKDANominationForm = () => {
  ...
  // Handle form submission - VALIDATE EVERYTHING HERE
  const handleSubmit = async (e) => {
    e.preventDefault();
    setIsSubmitting(true);

    try {
      // Validate all tabs at once
  ...
  return (
    <div className="border-gray-200 rounded-2xl dark:border-gray-800">
      ...
      <div className="flex justify-between items-center sm:mb-8 mb-2">
        <div>
          <h1 className="sm:text-xl text-md font-bold text-brand-500 dark:text-white mb-2">
            SKDA Nomination Form
          </h1>
          <p className="text-gray-600 dark:text-gray-400 sm:block hidden">
            Please complete all sections of the SKDA nomination form. Each tab
      ...
      <p className="text-gray-600 dark:text-gray-400 sm:hidden block mb-4 text-sm">
        Please complete all sections of the SKDA nomination form. Each tab must
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {activeTab === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <FormField>
                  <Label htmlFor="solution">Salutation *</Label>
                  <SelectSolution
          ...
          {activeTab === 2 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <FormField>
                  <Label htmlFor="nomineeSolution">Solution *</Label>
                  <SelectSolution
                    value={formData.nomineeSolution}
                    onChange={(value) =>
                      handleSelectChange("nomineeSolution", value)
                    }
                  />
                  {errors.nomineeSolution && (
                    <p className="mt-1 text-sm text-red-500">
                      {errors.nomineeSolution}
                    </p>
                  )}
            ...
            <div className="flex gap-3">
              {activeTab < 4 ? (
                ...
                <Button
                  ...
                  className="text-sm sm:text-base"
                >
                  {isSubmitting ? "Submitting..." : "Submit SKDA Nomination"}
                </Button>
              )}
            </div>
          </div>
...
export default SKDANominationForm;
// "use client";
// import React, { useState } from "react";
// import * as yup from "yup";
// import Button from "@/src/components/ui/button/Button";
...
//       console.log(`📋 SKDA TAB ${activeTab} COMPLETED - ALL FIELDS:`);
...
//           console.log("Solution:", formData.nomineeSolution);
...
//       console.log("🔍 SKDA VALIDATION STATUS:", {
//         tab1: tab1Valid,
//         tab2: tab2Valid,
//         tab3: tab3Valid,
//         tab4: tab4Valid,
...
//       if (tab1Valid && tab2Valid && tab3Valid && tab4Valid) {
//         console.log("🚀 SKDA NOMINATION FORM - FINAL SUBMISSION");
//         console.log("✅ ALL TABS VALIDATED SUCCESSFULLY");

//         // Log COMPLETE FORM DATA - ALL 4 TABS TOGETHER
//         console.log("📊 SKDA COMPLETE FORM DATA - ALL TABS:");
...
//         console.log({
//           nomineeSolution: formData.nomineeSolution,
...
//         setIsSubmitted(true);
//         console.log("🎉 SKDA NOMINATION SUBMITTED SUCCESSFULLY!");
//       } else {
//         console.log("❌ SKDA FORM VALIDATION FAILED:");
...
//       }
//     } catch (error) {
//       console.error("💥 SKDA SUBMISSION ERROR:", error);
//     } finally {
//       setIsSubmitting(false);
//     }
//   };
