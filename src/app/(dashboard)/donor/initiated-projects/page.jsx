...
const Page = () => {
  ...
  const getProgramLinks = (programId, program) => {
    ...
    links.push(
      <Link
        key="beneficiaries"
        href={`/donor/initiated-projects/view-beneficiaries-details/${programId}`}
    ...
    switch (programId) {
      ...
      case "program-c":
        ...
        links.push(
          <Link
            key="report"
            href={`/donor/initiated-projects/view-report/${programId}`}
            className="inline-flex items-center justify-center px-3 py-2 bg-white border border-brand-500 text-brand-600 rounded-lg hover:bg-brand-50 font-medium text-sm transition-colors shadow-sm"
          >
            View Report
          </Link>,
          <Link
            key="frl"
            href={`/donor/initiated-projects/view-frl/${programId}`}
            className="inline-flex items-center justify-center px-3 py-2 bg-white border border-brand-500 text-brand-600 rounded-lg hover:bg-brand-50 font-medium text-sm transition-colors shadow-sm"
          >
            View FRL
          </Link>,
      ...
      case "program-d":
        ...
        links.push(
          ...
          <Link
            key="uc"
            href={`/donor/initiated-projects/view-uc/${programId}`}
            className="inline-flex items-center justify-center px-3 py-2 bg-white border border-brand-500 text-brand-600 rounded-lg hover:bg-brand-50 font-medium text-sm transition-colors shadow-sm"
          >
            View UC
          </Link>,
