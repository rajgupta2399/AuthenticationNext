...
const ProgramReportsPage = () => {
  ...
  const openPdfViewer = async (pdfUrl) => {
    if (pdfUrl === "Not Available") {
      alert("Report is not available for this student.");
      return;
    }
            ...
            <Table>
              ...
              <TableHeader className="border-b border-gray-100 dark:border-white/[0.05] bg-gray-50 dark:bg-gray-800/50">
                <TableRow>
                  <TableCell
                    isHeader
                    className="px-2 py-2 font-semibold text-gray-700 dark:text-gray-300 sm:text-start text-center text-sm whitespace-nowrap sm:hidden block"
                  >
                    Report
                  </TableCell>
                  <TableCell
                  ...
                  <TableCell
                    isHeader
                    className="px-2 py-2 font-semibold text-gray-700 dark:text-gray-300 sm:text-start text-center text-sm whitespace-nowrap sm:block hidden"
                  >
                    Report
                  </TableCell>
                </TableRow>
              ...
              <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                {reports.map((report) => (
                  ...
                  >
                    <TableCell className="px-2 py-2 sm:text-start text-center text-theme-sm sm:hidden block">
                      {report.report === "Not Available" ? (
                        ...
                        <div className="flex space-x-2">
                          <Button
                            ...
                            // className="text-brand-600 hover:text-brand-700 font-medium text-theme-sm px-3 py-1 border border-brand-200 dark:border-brand-600 rounded-lg hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-all duration-200"
                          >
                            View
                          </Button>
                          <Button
                            onClick={() =>
                              handleDownloadReport(report.report, report.name)
                            }
                    ...
                    <TableCell className="px-2 py-2 sm:text-start text-center text-theme-sm text-gray-600 dark:text-gray-300 font-medium">
                      ₹{report.scholarshipAwardAmount}
                    </TableCell>
                    <TableCell className="px-2 py-2 sm:text-start text-center text-theme-sm text-gray-600 dark:text-gray-300">
                      {report.name}
                    </TableCell>
                    <TableCell className="px-2 py-2 sm:text-start text-center text-theme-sm text-gray-600 dark:text-gray-300">
                      {report.emailID}
                    ...
                    <TableCell className="px-2 py-2 sm:text-start text-center text-theme-sm sm:block hidden">
                      {report.report === "Not Available" ? (
                        <span className="text-gray-400 dark:text-gray-500 italic">
                          Not Available
                        </span>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 p-4 sm:p-6 border-t border-gray-200 dark:border-gray-700">
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 text-center sm:text-left">
                {isPdfLoading ? (
                  ...
                  `Viewing: ${programName} - Report Document`
                ) : (
                  "Ready to view"
                )}
              </div>
