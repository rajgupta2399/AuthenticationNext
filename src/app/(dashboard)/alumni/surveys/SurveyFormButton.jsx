  ...
  const nominationButtons = [
    {
      ...
      path: "/alumni/surveys/expression-interest-save-date",
    },
    {
      name: "Pre Registration Report",
      path: "/alumni/surveys/pre-registration-report",
    },
    {
      name: "Registration Form Report",
      path: "/alumni/surveys/registration-form-report",
    },
    {
      name: "Travel Details of Registration",
      path: "/alumni/surveys/travel-detail-registration",
    },
  ];
