...
const YaaNominationForm = () => {
  ...
  return (
    <div className="border-gray-200 rounded-md dark:border-gray-800">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 h-full">
        <TabNavigation
          activeTab={activeTab}
...
// // Fixed attachments schema - make supporting documents optional
// const attachmentsSchema = yup.object().shape({
//   recommendationDoc: yup
//     .mixed()
//     .required("Recommendation document is required")
...
//       return value.size <= 5 * 1024 * 1024;
//     }),
//   // Make supporting documents optional
//   supportingDoc1: yup.mixed().nullable(),
//   supportingDoc2: yup.mixed().nullable(),
//   supportingDoc3: yup.mixed().nullable(),
//   supportingDoc4: yup.mixed().nullable(),
...
//       // Log current tab data before moving to next
//       console.log(`📋 TAB ${activeTab} COMPLETED - ALL FIELDS:`);
...
//           console.log("Age:", formData.nominatorAge);
...
//           console.log("Age:", formData.nomineeAge);
...
//       if (tab1Valid && tab2Valid && tab3Valid && tab4Valid) {
//         console.log("🚀 YAA NOMINATION FORM - FINAL SUBMISSION");
//         console.log("✅ ALL TABS VALIDATED SUCCESSFULLY");

//         // Log COMPLETE FORM DATA - ALL 4 TABS TOGETHER
//         console.log("📊 COMPLETE FORM DATA - ALL TABS:");
...
//           nominatorAge: formData.nominatorAge,
...
//         setIsSubmitted(true);
//         console.log("🎉 YAA NOMINATION SUBMITTED SUCCESSFULLY!");
//       } else {
...
//       <div className="flex justify-between items-center sm:mb-8 mb-2">
//         <div>
//           <h1 className="text-xl font-bold text-brand-500 dark:text-white/90 mb-2">
//             YAA Nomination Form
//           </h1>
//           <p className="text-gray-600 dark:text-gray-400 sm:block hidden">
//             Please complete all sections of the nomination form. Each tab must
...
//         </div>
//       </div>
//       <p className="text-gray-600 dark:text-gray-400 sm:hidden block sm:mb-0 mb-4">
//         Please complete all sections of the nomination form. Each tab must be
//         completed before proceeding to the next.
//       </p>
