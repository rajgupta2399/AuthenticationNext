...
const nomineeSchema = yup.object().shape({
  ...
  nomineeMobile: yup
    ...
    .required("Mobile number is required")
    .matches(/^[0-9]{10}$/, "Please enter a valid 10-digit mobile number"),
  nomineeRollNumber: yup.string().optional(),
...
const otherInfoSchema = yup.object().shape({
  ...
  otherInformation: yup
    ...
    .max(2000, "Information must be 2000 characters or less"),
});
...
const TabNavigation = ({ activeTab, setActiveTab }) => {
  const tabs = [
    { id: 1, label: "Domain" },
    { id: 2, label: "Nominator" },
    { id: 3, label: "Nominee" },
    { id: 4, label: "Other Info" },
  ...
  <div className="p-8 text-center">
    <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-lg">
      ...
      <h3 className="text-2xl font-bold text-gray-800 dark:text-white/90 mb-2">
        DAA Nomination Submitted Successfully!
      </h3>
      <p className="text-gray-600 dark:text-gray-400">
        Thank you for submitting your DAA nomination. We'll review your
...
const DAANominationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Validate all tabs
      const tab1Valid = await domainSchema.isValid(formData);
      const tab2Valid = await nominatorSchema.isValid(formData);
      const tab3Valid = await nomineeSchema.isValid(formData);
      const tab4Valid = await otherInfoSchema.isValid(formData);
      const tab5Valid = await attachmentsSchema.isValid(formData);

      if (tab1Valid && tab2Valid && tab3Valid && tab4Valid && tab5Valid) {
        ...
        try {
          await domainSchema.validate(formData, { abortEarly: false });
        } catch (error) {
          if (error instanceof yup.ValidationError) {
            error.inner.forEach((err) => {
        ...
        // else if (!tab5Valid) setActiveTab(5);
      }
    } catch (error) {
  ...
  return (
    <div className="border-gray-200 rounded-2xl dark:border-gray-800">
      ...
      <div className="flex justify-between items-center sm:mb-8 mb-2">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 sm:block hidden">
            Please complete all sections of the DAA nomination form. Each tab
      ...
      <p className="text-gray-600 dark:text-gray-400 sm:hidden block mb-4 text-sm">
        Please complete all sections of the DAA nomination form. Each tab must
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {activeTab === 1 && (
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                >
                  Choose any of the below domains for submitting your
                  nominations *
                </Label>
          ...
          {activeTab === 3 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <FormField>
                  <Label htmlFor="nomineeRollNumber">Roll Number</Label>
                  <Input
                    id="nomineeRollNumber"
                    name="nomineeRollNumber"
                    type="text"
                    placeholder="Nominee's roll number"
                    value={formData.nomineeRollNumber}
                    onChange={handleChange}
                  />
                </FormField>
          ...
          {activeTab === 4 && (
            <div className="space-y-6">
              ...
              <div className="mb-6">
                <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">
                  To nominate kindly provide various social media and web links
                  of the candidate
                </h3>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <FormField>
                    <Label htmlFor="nomineeLinkedin">LinkedIn</Label>
                    <Input
                      id="nomineeLinkedin"
              ...
              <div className="space-y-4">
                ...
                <FormField>
                  ...
                  />
                  <div className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    {formData.otherInformation.length} / 2000
                  </div>
              ...
              <div className="space-y-6">
                <FormField>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">
                    Please attach a document containing your recommendation and
                    other details that will strengthen the nomination. PDF
                    format only and maximum file size allowed is 5MB.
                  </p>
                  <DropzoneComponent
                    onFilesChange={(files) =>
            ...
            <div className="flex gap-3">
              {activeTab < 5 ? (
                ...
                <Button type="submit" disabled={isSubmitting}>
                  {isSubmitting ? "Submitting..." : "Submit DAA Nomination"}
                </Button>
              )}
            </div>
          </div>
...
export default DAANominationForm;
// "use client";
// import React, { useState } from "react";
// import * as yup from "yup";
// import Button from "@/src/components/ui/button/Button";
...
//   { value: "professional-excellence", label: "Professional Excellence" },
//   {
//     value: "entrepreneurship-management",
//     label: "Entrepreneurship and Management",
//   },
//   { value: "service-humanity", label: "Service of Humanity at large" },
// ];
...
//     if (isValid && activeTab < 5) {
//       console.log(`📋 DAA TAB ${activeTab} COMPLETED - ALL FIELDS:`);
...
//           console.log("Graduation Year:", formData.graduationYear);
...
//           console.log("Current Designation:", formData.nomineeDesignation);
...
//           console.log("LinkedIn:", formData.nomineeLinkedin);
...
//       console.log("🔍 DAA VALIDATION STATUS:", {
//         tab1: tab1Valid,
//         tab2: tab2Valid,
//         tab3: tab3Valid,
//         tab4: tab4Valid,
...
//       if (tab1Valid && tab2Valid && tab3Valid && tab4Valid && tab5Valid) {
//         console.log("🚀 DAA NOMINATION FORM - FINAL SUBMISSION");
//         console.log("✅ ALL TABS VALIDATED SUCCESSFULLY");

//         // Log COMPLETE FORM DATA - ALL 5 TABS TOGETHER
//         console.log("📊 DAA COMPLETE FORM DATA - ALL TABS:");

//         console.log("=== TAB 1: DOMAIN SELECTION ===");
//         console.log({
//           domain: formData.domain,
//         });

//         console.log("=== TAB 2: NOMINATOR DETAILS ===");
//         console.log({
...
//         console.log("=== TAB 3: NOMINEE DETAILS ===");
//         console.log({
//           nomineeSalutation: formData.nomineeSalutation,
//           nomineeName: formData.nomineeName,
//           nomineeEmail: formData.nomineeEmail,
//           nomineeMobile: formData.nomineeMobile,
//           nomineeRollNumber: formData.nomineeRollNumber,
...
//           nomineeDesignation: formData.nomineeDesignation,
//           nomineeOrganization: formData.nomineeOrganization,
//           nomineeCountry: formData.nomineeCountry,
//         });

//         console.log("=== TAB 4: OTHER INFORMATION ===");
//         console.log({
//           nomineeLinkedin: formData.nomineeLinkedin,
...
//         setIsSubmitted(true);
//         console.log("🎉 DAA NOMINATION SUBMITTED SUCCESSFULLY!");
//       } else {
//         console.log("❌ DAA FORM VALIDATION FAILED:");
//         console.log("Tab 1 (Domain):", tab1Valid);
//         console.log("Tab 2 (Nominator):", tab2Valid);
//         console.log("Tab 3 (Nominee):", tab3Valid);
//         console.log("Tab 4 (Other Info):", tab4Valid);
//         console.log("Tab 5 (Attachments):", tab5Valid);
...
//       }
//     } catch (error) {
//       console.error("💥 DAA SUBMISSION ERROR:", error);
//     } finally {
//       setIsSubmitting(false);
//     }
//   };
...
//                 className="text-lg font-medium mb-4 block"
//               >
//                 Choose any of the below domains for submitting your nominations
//                 *
//               </Label>
...
//             <div className="mb-6">
//               <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">
//                 To nominate kindly provide various social media and web links of
//                 the candidate
//               </h3>
...
//                 <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">
//                   Please attach a document containing your recommendation and
//                   other details that will strengthen the nomination. PDF format
//                   only and maximum file size allowed is 5MB.
//                 </p>
//                 <DropzoneComponent
//                   onFilesChange={(files) =>
//                     handleFileUpload("recommendationDoc", files)
